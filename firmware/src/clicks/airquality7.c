...
void AIRQUALITY7_readData(air7_data_struct *air7_data)
{
    ...
    //Read the i2c buffer
    rec_data[0] = app_deviceData.i2c.rxBuffBytes[0];
    rec_data[1] = app_deviceData.i2c.rxBuffBytes[1];
    rec_data[2] = app_deviceData.i2c.rxBuffBytes[2];
    rec_data[3] = app_deviceData.i2c.rxBuffBytes[3];
    rec_data[4] = app_deviceData.i2c.rxBuffBytes[4];
    rec_data[5] = app_deviceData.i2c.rxBuffBytes[5];
    rec_data[6] = app_deviceData.i2c.rxBuffBytes[6];
