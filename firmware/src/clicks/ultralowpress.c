...
uint32_t ULTRALOWPRESS_init()
{
    ...
    app_deviceData.i2c.rxBuffWords[0] = 0;
    app_deviceData.i2c.rxBuffWords[1] = 0;
    ...
    serial_number = app_deviceData.i2c.rxBuffWords[1] << 16;
    serial_number |= app_deviceData.i2c.rxBuffWords[0];
...
{   
    ...
    status_reg = app_deviceData.i2c.rxBuffWords[0];
...
void ULTRALOWPRESS_getData(ulp_data_struct *ulp_data)
{
    ...
    for (int index = 0; index < 10; index++) {
        app_deviceData.i2c.rxBuffWords[index] = 0;
    }
    ...
    decimal = ULTRALOWPRESS_2sCompToDecimal(app_deviceData.i2c.rxBuffWords[0]);
